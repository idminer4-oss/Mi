...
// Mendefinisikan interface window untuk memanggil fungsi dari index.html
declare global {
  interface Window {
    markAppAsReady: () => void;
  }
...
const App: React.FC = () => {
  ...
  // Trigger Loader Hide
  useEffect(() => {
    // Memberitahu index.html bahwa React siap
  ...
  return (
    <div className="min-h-screen flex flex-col max-w-md mx-auto bg-[#0a0a0c] text-white shadow-2xl relative border-x border-gray-800">
      ...
      <main className="flex-1 overflow-y-auto pb-24 px-4 pt-4 animate-in fade-in duration-500">
        {renderContent()}
      </main>
